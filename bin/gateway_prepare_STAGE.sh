...
## APIs and to prepare the APIs for the STAGE environment.
## This creates an single node Docker based API Gateway environment 
## imports the entire set and of API Projects and then run the tests suites 
## against the build machine, removes all non-STAGE applications
## and exports all APIs into the apis_STAGE folder.
## Parameters: 
